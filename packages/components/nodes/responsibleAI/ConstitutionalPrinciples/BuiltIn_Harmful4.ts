...
class BuiltIn_Harmful4 extends AbstractPrinciple implements INode {
    constructor() {
        let principle: ConstitutionalPrinciple = PRINCIPLES.harmful4
        super({
            name: principle.name,
            critiqueRequest: principle.critiqueRequest,
            revisionRequest: principle.revisionRequest
        })
        this.label = 'Built In - Harmful 4'
        this.name = 'harmful4'
        this.version = 1.0
    }
...
module.exports = { nodeClass: BuiltIn_Harmful4 }
