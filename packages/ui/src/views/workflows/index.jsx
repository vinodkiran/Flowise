...
// material-ui
import { Grid, Box, Stack, ToggleButton, TableContainer, Paper, Table, TableHead, TableRow, TableBody, Skeleton, Chip } from '@mui/material'
                                ...
                                <Table sx={{ minWidth: 650 }} aria-label='simple table'>
                                    ...
                                    <TableBody>
                                        {isLoading ? (
                                            ...
                                            <>
                                                {getAllWorkflowsApi.data &&
                                                    getAllWorkflowsApi.data.map((exec, index) => (
                                                        <StyledTableRow
                                                            key={index}
                                                            hover
                                                            onClick={() => goToCanvas(exec)}
