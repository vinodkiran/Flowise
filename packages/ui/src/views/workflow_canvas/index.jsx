...
import webhooksApi from '@/api/workflows.webhooks'
...
const Canvas = () => {
    ...
    const getNodesApi = useApi(nodesApi.getWorkflowNodes)
    ...
    const handleStopWorkflow = async () => {
        try {
            ...
            //setWorkflow(stoppedWorkflowResponse)
    ...
    useEffect(() => {
        if (createNewWorkflowApi.data) {
            ...
            dispatch({ type: SET_WORKFLOW, workflow })
            saveWorkflowSuccess()
            window.history.replaceState(null, null, `/workflow_canvas/${workflow.shortId}`)
    ...
    useEffect(() => {
        if (updateWorkflowApi.data) {
            //setWorkflow(updateWorkflowApi.data)
