...
import webhookApi from '@/api/workflows.webhooks'

// Hooks
import useApi from '@/hooks/useApi'

// icons
import { IconExclamationMark, IconCopy, IconArrowUpRightCircle, IconX, IconArrowsMaximize } from '@tabler/icons-react'
...
const OutputResponses = ({ nodeId, nodeParamsType, nodeFlowData, nodes, edges, workflow, onSubmit }) => {
    ...
    const testNodeApi = useApi(workflowAPI.testWorkflowNode)
            ...
            <Box sx={{ width: 400 }}>
                ...
                {nodeName && (nodeName === 'webhook' || nodeName === 'chainLinkFunctionWebhook') && (
                    <Box sx={{ mb: 3 }}>
                        ...
                        >
                            {`${baseURL}/api/v1/workflows/webhook/${nodeFlowData.webhookEndpoint}`}
                        </Typography>
                        <Stack direction='row' spacing={2}>
                            ...
                            <Button
                                ...
                                onClick={() => window.open(`${baseURL}/api/v1/workflows/webhook/${nodeFlowData.webhookEndpoint}`, '_blank')}
                            >
                                Open in New Tab
                            </Button>
                        </Stack>
